...
public class demo {
    ...
    public void signIn()throws InterruptedException{
        ...
        signIn.click();
        sleep(2000);
        driver.findElement(By.cssSelector("[name='email']")).sendKeys("uswahshamim777@gmail.com");
        sleep(2000);
        driver.findElement(By.cssSelector("[id='passwd']")).sendKeys("48900uswah");
        sleep(2000);
    ...
    public void logIn() throws InterruptedException {
        ...
        driver.manage().timeouts().implicitlyWait(2000, TimeUnit.MILLISECONDS);
        driver.findElement(By.cssSelector("[name='email_create']")).sendKeys("uswashahmim049@gmail.com");
